  ...
  return (function (e) {
          ...
          !(function (e, t) {
            ...
            (this.deregister = function (e) {
              ...
              ;-1 !== n
                ...
                : console.warn('React-Modal: Unable to deregister ' + e + ' as it was never registered')
            }),
    ...
    function (e, t, n) {
      ...
      var S = (function (e) {
        function t() {
          ...
          return (
            (n = r = h(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(s)))),
        ...
        (e.exports = function (e, t) {
          ...
          var c = {
            ...
            arrayOf: function (e) {
              return d(function (t, n, o, r, l) {
                if ('function' != typeof e)
                  return new p(
                    'Property `' + l + '` of component `' + o + '` has invalid PropType notation inside arrayOf.',
                  )
                var i = t[n]
                if (!Array.isArray(i))
                  return new p(
                    'Invalid ' + r + ' `' + l + '` of type `' + h(i) + '` supplied to `' + o + '`, expected an array.',
                  )
            ...
            node: d(function (e, t, n, o, r) {
              return m(e[t])
                ? null
                : new p('Invalid ' + o + ' `' + r + '` supplied to `' + n + '`, expected a ReactNode.')
            }),
            objectOf: function (e) {
              return d(function (t, n, o, r, l) {
                if ('function' != typeof e)
                  return new p(
                    'Property `' + l + '` of component `' + o + '` has invalid PropType notation inside objectOf.',
                  )
                var s = t[n],
                  u = h(s)
                if ('object' !== u)
                  return new p(
                    'Invalid ' + r + ' `' + l + '` of type `' + u + '` supplied to `' + o + '`, expected an object.',
                  )
                for (var c in s)
                  if (i(s, c)) {
            ...
            oneOf: function (e) {
              ...
              function t(t, n, o, r, a) {
                for (var l = t[n], i = 0; i < e.length; i++) if (f(l, e[i])) return null
            ...
            oneOfType: function (e) {
              if (!Array.isArray(e))
                return s('Invalid argument supplied to oneOfType, expected an instance of array.'), u
              ...
              return d(function (t, n, o, r, l) {
                ...
                return new p('Invalid ' + r + ' `' + l + '` supplied to `' + o + '`.')
              })
            },
            shape: function (e) {
              return d(function (t, n, o, r, l) {
                ...
                if ('object' !== s)
                  return new p(
                    'Invalid ' + r + ' `' + l + '` of type `' + s + '` supplied to `' + o + '`, expected `object`.',
                  )
                for (var u in e) {
                  var c = e[u]
                  if (c) {
            ...
            exact: function (e) {
              return d(function (t, n, o, l, i) {
                ...
                if ('object' !== u)
                  return new p(
                    'Invalid ' + l + ' `' + i + '` of type `' + u + '` supplied to `' + o + '`, expected `object`.',
                  )
                var c = r({}, t[n], e)
                for (var f in c) {
                  var d = e[f]
          ...
          function d(e) {
            ...
            function r(r, l, i, u, c, f, d) {
              ...
              return null == l[i]
                ? r
                  ? null === l[i]
                    ? new p('The ' + c + ' `' + f + '` is marked as required in `' + u + '`, but its value is `null`.')
                    : new p(
                        'The ' + c + ' `' + f + '` is marked as required in `' + u + '`, but its value is `undefined`.',
                      )
                  : null
                : e(l, i, u, c, f)
            }
      ...
      e.exports = (function () {
        ...
        : function (e, t) {
            for (var n, i, s = l(e), u = 1; u < arguments.length; u++) {
              ...
              if (o) {
                i = o(n)
                for (var f = 0; f < i.length; f++) a.call(n, i[f]) && (s[i[f]] = n[i[f]])
              }
            }
            return s
          }
    ...
    function (e, t, n) {
      ...
      Object.defineProperty(t, '__esModule', {
        ...
        (t.default = function (e, t) {
          ...
          u > -1 && (u += r ? -1 : 1)
          if (void 0 === (o = n[u])) return t.preventDefault(), void (o = r ? i : l).focus()
    ...
    */
    ...
    function (e, t, n) {
      ...
      function u() {
        0 !== s.length ? s[s.length - 1].focusContent() : console.warn('React-Modal: Open instances > 0 expected')
      }
      a.default.subscribe(function (e, t) {
        l ||
          ...
          (s = t).length > 0
            ? (document.body.firstChild !== l && document.body.insertBefore(l, document.body.firstChild),
              document.body.lastChild !== i && document.body.appendChild(i))
            : (l.parentElement && l.parentElement.removeChild(l), i.parentElement && i.parentElement.removeChild(i))
      })
    },
    function (e, t, n) {
      'use strict'
      ...
      function l(e) {
        ...
        if (
          ...
          'function' == typeof t.componentWillReceiveProps
            ...
            : 'function' == typeof t.UNSAFE_componentWillReceiveProps && (l = 'UNSAFE_componentWillReceiveProps'),
          'function' == typeof t.componentWillUpdate
            ? (i = 'componentWillUpdate')
            : 'function' == typeof t.UNSAFE_componentWillUpdate && (i = 'UNSAFE_componentWillUpdate'),
